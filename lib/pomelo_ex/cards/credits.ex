defmodule PomeloEx.Cards.Credits do
  ...
  defdelegate modify_pending_price_update(payload), to: CreditProduct, as: :modify_pending_price_update
  ...
  defdelegate simulate_expiration_date_update(payload), to: CreditLines, as: :simulate_expiration_date_update
  ...
  defdelegate simulate_total_debt_acceleration(payload), to: CreditLines, as: :simulate_total_debt_acceleration
  defdelegate confirm_total_debt_acceleration(payload), to: CreditLines, as: :confirm_total_debt_acceleration
  defdelegate simulate_acceleration_of_specific_installments(payload), to: CreditLines, as: :simulate_acceleration_of_specific_installments
  defdelegate confirm_acceleration_of_debt_for_specific_installments(payload), to: CreditLines, as: :confirm_acceleration_of_debt_for_specific_installments
  ...
  defdelegate debt_creation_notification(payload), to: DebtSaleToBanks, as: :debt_creation_notification
  defdelegate debt_payment_notification(payload), to: DebtSaleToBanks, as: :debt_payment_notification
  defdelegate debt_transfer_notification(payload), to: DebtSaleToBanks, as: :debt_transfer_notification
  defdelegate debt_adjustment_notification(payload), to: DebtSaleToBanks, as: :debt_adjustment_notification
  defdelegate debt_cancellation_notification(payload), to: DebtSaleToBanks, as: :debt_cancellation_notification
  defdelegate processed_transactions_notifications(payload), to: Webhooks, as: :processed_transactions_notifications
  defdelegate reversed_transactions_notifications(payload), to: Webhooks, as: :reversed_transactions_notifications
  defdelegate credit_line_pause_unpause_notifications(payload), to: Webhooks, as: :credit_line_pause_unpause_notifications
  defdelegate entry_exit_from_arrears_user_notifications(payload), to: Webhooks, as: :entry_exit_from_arrears_user_notifications
  defdelegate created_summaries_notifications(payload), to: Webhooks, as: :created_summaries_notifications
end
