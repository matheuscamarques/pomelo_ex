defmodule PomeloEx.Cards.Credits.CreditLinesV2.CreatePricing do
  @moduledoc false

  alias PomeloEx.Types.Cards.Credits.CreditLinesV2.CreatePricingType

  def execute(%CreatePricingType{token: token, product_id: product_id} = payload) do
    headers = build_headers(token)
    body = payload.body |> Jason.encode!()

    PomeloEx.Client.request(:post, "/lending/v2/products/#{product_id}/pricing", body, headers)
  end
