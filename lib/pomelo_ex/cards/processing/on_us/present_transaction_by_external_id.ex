defmodule PomeloEx.Cards.Processing.OnUs.PresentTransactionByExternalId do
  @moduledoc false

  alias PomeloEx.Types.Cards.Processing.OnUs.PresentTransactionByExternalIdType

  def execute(%PresentTransactionByExternalIdType{token: token} = payload) do
    ...
    PomeloEx.Client.request(:post, "/on-us/v1/presentments", body, headers)
  end
