defmodule PomeloEx.Cards.Processing do
  ...
  defdelegate reverse_transaction_by_external_id(payload),
    to: OnUs,
    as: :reverse_transaction_by_external_id

  defdelegate present_transaction_by_external_id(payload),
    to: OnUs,
    as: :present_transaction_by_external_id

  defdelegate present_transaction_by_pomelo_id(payload),
    to: OnUs,
    as: :present_transaction_by_pomelo_id
  ...
  defdelegate presentments_notifications(payload),
    to: Transactions,
    as: :presentments_notifications

  defdelegate card_shipping_of_otp_codes(payload),
    to: Transactions,
    as: :card_shipping_of_otp_codes
