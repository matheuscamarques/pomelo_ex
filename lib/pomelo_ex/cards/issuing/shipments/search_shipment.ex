defmodule PomeloEx.Cards.Issuing.Shipments.SearchShipment do
  ...
  def execute(%SearchShipmentType{token: token} = payload) do
    ...
    PomeloEx.Client.request(:get, "/shipping/v1/?#{params}", nil, headers)
  end
  ...
  defp to_query_params(%SearchShipmentType{} = params) do
    params
    |> Map.from_struct()
