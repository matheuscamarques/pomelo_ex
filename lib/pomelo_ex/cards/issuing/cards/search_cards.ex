defmodule PomeloEx.Cards.Issuing.Cards.SearchCards do
  ...
  def execute(%SearchCardsType{token: token} = payload) do
    ...
    PomeloEx.Client.request(:get, "/cards/v1/?#{params}", nil, headers)
  end
  ...
  defp to_query_params(%SearchCardsType{} = params) do
    params
    |> Map.from_struct()
