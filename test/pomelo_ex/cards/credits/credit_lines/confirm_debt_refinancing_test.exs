defmodule PomeloEx.Cards.Credits.CreditLines.ConfirmDebtRefinancingTest do
  use ExUnit.Case
  import Mox
  ...
  test "Success 200 - Confirm Debt Refinancing" do
    ...
    {:ok, response} = ConfirmDebtRefinancing.execute(payload)

    body = Jason.decode!(response.body)
    assert body["data"] =~ "Refinancing confirmed"
  end
end
